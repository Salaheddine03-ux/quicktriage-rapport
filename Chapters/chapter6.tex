...
\multirow{2}{*}{Frontend}
 ...
 & package \texttt{http} & Consommation de l'API REST \\
\midrule
...
L'échange entre le client Flutter et le backend repose sur JSON. Le listing~\ref{lst:json}
...
Application Flutter & Frontend & Saisie et restitution mobile \\
\bottomrule
\end{tabular}
...
\figplaceholder{[Figure 6.2 -- Écran de saisie des constantes vitales dans l'application Flutter.]}
\begin{figure}[h]
\centering
