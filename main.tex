...
\textbf{ONNX} via une API REST \textbf{JAX-RS} ; et (iii) un \textbf{frontend Android}
...
apprentissage automatique, XGBoost, ONNX, Jakarta EE, JAX-RS, Android, SMOTE, Optuna.
...
\textbf{ONNX} model through a \textbf{JAX-RS} REST API; and (iii) a mobile \textbf{Android}
...
learning, XGBoost, ONNX, Jakarta EE, JAX-RS, Android, SMOTE, Optuna.
